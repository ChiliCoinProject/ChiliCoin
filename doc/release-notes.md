...
ChiliCoin Core v3.0.4 is a mandatory update for all users. This release contains various updates/fixes pertaining to the zXLR protocol, supply tracking, block transmission and relaying, as well as usability and quality-of-life updates to the GUI.
...
- #294 `27c0943` Add additional checks for txid for zxlr spend. (presstab)
