...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("ChiliCoin Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  chilicoin-cli [options] <command> [params]  " + _("Send command to ChiliCoin Core") + "\n" +
                        "  chilicoin-cli [options] help                " + _("List commands") + "\n" +
                        "  chilicoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
