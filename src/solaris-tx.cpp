...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ChiliCoin Core chilicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  chilicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded chilicoin transaction") + "\n" +
                               "  chilicoin-tx [options] -create [commands]   " + _("Create hex-encoded chilicoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded chilicoin transaction
