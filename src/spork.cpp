...
// Copyright (c) 2016-2017 The ChiliCoin developers
...
// ChiliCoin: on startup load spork values from previous session if they exist in the sporkDB
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // ChiliCoin: add to spork database.
