                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ChiliCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ChiliCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and chilicoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCHILI"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ChiliCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ChiliCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ChiliCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ChiliCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ChiliCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a ChiliCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ChiliCoin Core help message to get a list with possible ChiliCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ChiliCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ChiliCoin network", "", count));
}
...
{
    QString strTitle = tr("ChiliCoin Core"); // default title
