...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ChiliCoin Core"),
     ...
     * override -datadir in the chilicoin.conf file in the default data directory
     * (to be consistent with chilicoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
