                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received CHILI from zCHILI"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCHILI"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCHILI));
